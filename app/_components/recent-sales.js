  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center">
        ...
        <div className="ml-4 space-y-1">
          <p className="text-sm font-medium leading-none">Emma Johnson</p>
          <p className="text-sm text-muted-foreground">emma.johnson@example.com</p>
        </div>
      ...
      <div className="flex items-center">
        ...
        <div className="ml-4 space-y-1">
          <p className="text-sm font-medium leading-none">Michael Park</p>
          <p className="text-sm text-muted-foreground">michael.park@example.com</p>
        </div>
